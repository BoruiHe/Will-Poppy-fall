...
from model import model_shallow, init_weights
import random
...
def training():
    ...
    # path
    root_path = os.getcwd()
    checkpoint_name = 'ps{}_ep{}_R_Sh_zcor'.format(HpParams['prediction_span'], HpParams['epochs'])
    ...
    for seed in HpParams['random seeds']:
        ...
        for fold, (train_idx, val_idx) in enumerate(folds):
            ...
            toy_model = model_shallow(residual=True, dense=False)
