...
#     def __init__(self, height, width, latent_size):
#         super().__init__()
#         self.h = height
#         self.w = width
#         self.pool_1 = nn.MaxPool2d((3, 3), stride=(2, 2))
#         self.conv1 = nn.Sequential(nn.Conv2d(3, 64, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1)),
#                                    nn.BatchNorm2d(64),
#                                    nn.ReLU())
        
#         self.conv1_branch_2 = nn.Sequential(nn.Conv2d(64, 128, kernel_size=(1), stride=(1), padding=0),
#                                             nn.BatchNorm2d(128),
#                                             nn.ReLU(),
...
#         self.conv1_branch_1 = nn.Sequential(nn.Conv2d(64, 256, kernel_size=(1), stride=(1), padding=0),
#                                             nn.BatchNorm2d(256))
        
#         self.conv2 = nn.Sequential(nn.Conv2d(256, 128, kernel_size=(1), stride=(1), padding=0),
#                                             nn.BatchNorm2d(128),
#                                             nn.ReLU(),
#                                             nn.Conv2d(128, 128, kernel_size=(3), stride=(1), padding=1),
#                                             nn.BatchNorm2d(128),
...
#         self.conv3_branch_2 = nn.Sequential(nn.Conv2d(256, 128, kernel_size=(1, 1), stride=(2, 2), padding=0),
#                                             nn.BatchNorm2d(128),
#                                             nn.ReLU(),
#                                             nn.Conv2d(128, 128, kernel_size=(3), stride=(1), padding=1),
#                                             nn.BatchNorm2d(128),
...
#         self.conv3_branch_1 = nn.Sequential(nn.Conv2d(256, 512, kernel_size=(1, 1), stride=(2, 2), padding=0),
#                                             nn.BatchNorm2d(512))
        
#         self.conv4_branch_2 = nn.Sequential(nn.Conv2d(512, 256, kernel_size=(1, 1), stride=(2, 2), padding=0),
#                                             nn.BatchNorm2d(256),
#                                             nn.ReLU(),
#                                             nn.Conv2d(256, 256, kernel_size=(3), stride=(1), padding=1),
#                                             nn.BatchNorm2d(256),
#                                             nn.ReLU(),
#                                             nn.Conv2d(256, latent_size, kernel_size=(1), stride=(1), padding=0),
#                                             nn.BatchNorm2d(latent_size))
        
#         self.conv4_branch_1 = nn.Sequential(nn.Conv2d(512, latent_size, kernel_size=(1, 1), stride=(2, 2), padding=0),
#                                             nn.BatchNorm2d(latent_size))
#         self.relu = nn.ReLU()
#         self.DynSize = self.dynamic_size(torch.zeros(1, 3, self.h, self.w))
#         self.pool_2 = nn.AvgPool2d(tuple(self.DynSize), stride=(1))
#         self.convt3d_1 = nn.ConvTranspose2d(latent_size, 512, kernel_size=3, stride=2, padding=1, output_padding=1)
#         if self.h == 128:
#             self.convt3d_2 = nn.ConvTranspose2d(512, 256, kernel_size=3, stride=2, padding=1, output_padding=1)
#         elif self.h == 96:
#             self.convt3d_2 = nn.ConvTranspose2d(512, 256, kernel_size=3, stride=2, padding=1, output_padding=(0,1))
#         self.convt3d_3 = nn.ConvTranspose2d(256, 256, kernel_size=3, stride=2, padding=1, output_padding=1)
#         self.convt3d_4 = nn.ConvTranspose2d(256, 64, kernel_size=(3, 3), stride=(2,2), padding=1, output_padding=(1,1))
#         self.convt3d_5 = nn.ConvTranspose2d(64, 64, kernel_size=(3, 3), stride=(2,2), padding=1, output_padding=(1,1))
#         self.convt3d_6 = nn.ConvTranspose2d(64, 3, kernel_size=3, stride=(2,2), padding=1, output_padding=(1,1))
#         self.convt3d_7 = nn.ConvTranspose2d(3, 3, kernel_size=3, stride=(2,2), padding=1, output_padding=(1,1))

#     def forward(self, input):
#         # inputs shpae: (4, 3, 128, 128) ->(bs, C, H, W)
#         input = self.pool_1(input) # shpae: (4, 64, 163, 63) ->(bs, C, H, W)
#         out = self.conv1(input) # shpae: (4, 64, 32, 32) ->(bs, C, H, W)
#         out1_b_2 = self.conv1_branch_2(out) # shpae: (4, 128, 32, 32) ->(bs, C, H, W)

#         out1_b_2 += self.conv1_branch_1(out)
#         out1_b_2 = self.relu(out1_b_2) # shpae: (4, 256, 32, 32) ->(bs, C, H, W)

#         out2_b_2 = self.conv2(out1_b_2) # shpae: (4, 256, 32, 32) ->(bs, C, H, W)

#         out2_b_2 += out1_b_2
#         out2_b_2 = self.relu(out2_b_2) # shpae: (4, 256, 32, 32) ->(bs, C, H, W)

#         out3_b_2 = self.conv3_branch_2(out2_b_2) # shpae: (4, 512, 16, 16) ->(bs, C, H, W)

#         out3_b_2 += self.conv3_branch_1(out2_b_2)
#         out3_b_2 = self.relu(out3_b_2) # shpae: (4, 512, 16, 16) ->(bs, C, H, W)
        
#         out4_b_2 = self.conv4_branch_2(out3_b_2) # shpae: (4, 1024, 8, 8) ->(bs, C, H, W)

#         out4_b_2 += self.conv4_branch_1(out3_b_2)
#         out4_b_2 = self.relu(out4_b_2) # shpae: (4, 1024, 8, 8) ->(bs, C, H, W)

#         out = self.pool_2(out4_b_2) # shpae: (4, 1024, 1, 1) ->(bs, C, H, W)
        
#         reconst_vc = self.convt3d_1(out) # tensor(batch, 512, 2, 2)
    
#         reconst_vc = self.convt3d_2(reconst_vc) # tensor(batch, 256, 4/3, 4)
#         reconst_vc = self.convt3d_3(reconst_vc) # tensor(batch, 256, 8/6, 8)
#         reconst_vc = self.convt3d_4(reconst_vc) # tensor(batch, 64, 16/12, 16)
#         reconst_vc = self.convt3d_5(reconst_vc) # tensor(batch, 64, 32/24, 32)
#         reconst_vc = self.convt3d_6(reconst_vc) # tensor(batch, 3, 64/48, 64)
#         reconst_vc = self.convt3d_7(reconst_vc) # tensor(batch, 3, 128/96, 128)
...
#         out1_b_2 += self.conv1_branch_1(out)
#         out1_b_2 = self.relu(out1_b_2) # (1, 256, 24, 32)

#         out2_b_2 = self.conv2(out1_b_2)

#         out2_b_2 += out1_b_2
#         out2_b_2 = self.relu(out2_b_2) # (1, 256, 24, 32)

#         out3_b_2 = self.conv3_branch_2(out2_b_2)

#         out3_b_2 += self.conv3_branch_1(out2_b_2)
#         out3_b_2 = self.relu(out3_b_2) # (1, 512, 12, 16)
        
#         out4_b_2 = self.conv4_branch_2(out3_b_2)

#         out4_b_2 += self.conv4_branch_1(out3_b_2)
#         out4_b_2 = self.relu(out4_b_2) # (1, 1024, 6, 8)
